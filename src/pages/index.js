  ...
  return (
    ...
    >
      ...
      <div className="m-10 grid sm:grid-cols-2">
        <div className="w-1/2 min-h-[300px] min-w-[500px] rounded-lg bg-gray-800 shadow">
      ...
      <div className="absolute left-0 right-0 top-0 -z-50 h-[40rem] w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
        {/* <img
